          ...
          context 'title == name (pass)' do
            ...
            let(:runner) do
              ...
              ChefSpec::SoloRunner.new(
                step_into: %w[gspanner_database gspanner_instance],
            ...
            let(:chef_run) do
              apply_recipe(
                <<-MANIFEST
                  gspanner_instance 'resource(instance,0)' do
                    action :create
                  ...
                  gspanner_instance 'resource(instance,1)' do
                    action :create
                  ...
                  gspanner_instance 'resource(instance,2)' do
                    action :create
            ...
            context 'gspanner_database[title0]' do
              subject do
                chef_run.find_resource(:gspanner_database, 'title0')
              end
            ...
            context 'gspanner_database[title1]' do
              subject do
                chef_run.find_resource(:gspanner_database, 'title1')
              end
            ...
            context 'gspanner_database[title2]' do
              subject do
                chef_run.find_resource(:gspanner_database, 'title2')
              end
      ...
      context 'title == name' do
        ...
        context 'title == name (pass)' do
          ...
          it 'should run test correctly' do
            expect(chef_run).to create(:gspanner_database,
                                       'title0')
          end
          it { is_expected.to have_attributes(d_label: 'title0') }
    ...
    context 'resource exists' do
      ...
      context 'title == name' do
        ...
        context 'title == name (pass)' do
          ...
          it 'should run test correctly' do
            expect(chef_run).to delete(:gspanner_database,
                                       'title0')
          end
        end
