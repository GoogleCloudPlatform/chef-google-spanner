...
context 'gspanner_instance' do
          ...
          context 'title == name (pass)' do
            ...
            let(:runner) do
              ...
              ChefSpec::SoloRunner.new(
                step_into: %w[gspanner_instance gspanner_instance_config],
            ...
            let(:chef_run) do
              apply_recipe(
                <<-MANIFEST
                  gspanner_instance_config 'resource(instance_config,0)' do
                    action :create
                    ic_label 'test name#0 data'
                    project 'test project#0 data'
                    credential 'mycred'
                  end

                  gspanner_instance_config 'resource(instance_config,1)' do
                    action :create
                    ic_label 'test name#1 data'
                    project 'test project#1 data'
                    credential 'mycred'
                  end

                  gspanner_instance_config 'resource(instance_config,2)' do
                    action :create
                    ic_label 'test name#2 data'
                    project 'test project#2 data'
                    credential 'mycred'
                  end

                  gspanner_instance 'title0' do
                    action :create
            ...
            context 'gspanner_instance[title0]' do
              subject do
                chef_run.find_resource(:gspanner_instance, 'title0')
              end
            ...
            context 'gspanner_instance[title1]' do
              subject do
                chef_run.find_resource(:gspanner_instance, 'title1')
              end
            ...
            context 'gspanner_instance[title2]' do
              subject do
                chef_run.find_resource(:gspanner_instance, 'title2')
              end
      ...
      context 'title == name' do
        ...
        context 'title == name (pass)' do
          ...
          it 'should run test correctly' do
            expect(chef_run).to create(:gspanner_instance,
                                       'title0')
          end
          it { is_expected.to have_attributes(i_label: 'title0') }
    ...
    context 'resource exists' do
      ...
      context 'title == name' do
        ...
        context 'title == name (pass)' do
          ...
          it 'should run test correctly' do
            expect(chef_run).to delete(:gspanner_instance,
                                       'title0')
          end
        end
  ...
  def expand_variables_instance_config(template, data, ext_dat = {})
    Google::GSPANNER::InstanceConfig
  ...
  def apply_recipe(recipe)
    ...
    recipe_path = "google-gspanner::#{recipe_name}"
    begin
      yield recipe_path
    ensure
